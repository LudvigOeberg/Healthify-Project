...
import { Container, Grid, Button, FormControl, InputLabel, Input, Divider } from '@material-ui/core'
...
const mapDispatchToProps = (dispatch) => ({
  onChange: (key, value) => dispatch({ type: UPDATE_FIELD_AUTH, key, value }),
        ...
        <Card elevation={5} className={classes.card}>
          ...
          <CardContent>
            ...
            <FormControl fullWidth className={classes.inputs}>
              ...
              <Input value={reward} fullWidth id="reward" margin="dense" labelId="reward-label" onChange={sendForm} />
            </FormControl>
