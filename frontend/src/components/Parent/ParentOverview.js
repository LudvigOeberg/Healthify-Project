              ...
              <Paper className={classes.paper} elevation={2}>
                <Grid container spacing={1} alignItems="center" justify="center">
                  ...
                  <Grid item xs={12} md={6}>
                    <Button id="toChildValues" variant="contained" color="secondary" href={`/monitor-child/${id}`} fullWidth>
                      Hantera värden
                    </Button>
                  </Grid>
                  <Grid item xs={12} md={6}>
                    <Button id="toSimulatePage" variant="contained" color="secondary" href={`/simulate-patient/${id}`} fullWidth>
                      Simulera värden
                    </Button>
                  </Grid>
                </Grid>
