...
const RewardCard = (props) => {
  ...
  return (
    <Container className={classes.root}>
            ...
            <CardContent className={classes.card}>{one_reward.description}</CardContent>
            <CardContent className={classes.card}>Belöning: {one_reward.reward}</CardContent>
            <CardContent className={classes.card}>Slutdatum: {one_reward.endDate}</CardContent>
            <CardContent className={classes.card} ><Typography variant="caption"> Avklarad<LinearProgress color="primary" size={40} thickness={50} variant="determinate" value="40" /> </Typography></CardContent>
          </Card>
